...
/**
 * Коды встроенных обложек чата. Список ОБЯЗАН совпадать с картинками в
 * приложении (`composeResources/drawable`): сервер раздаёт только код, саму
 * картинку рисует клиент. Неизвестный код клиент покажет градиентом, так что
 * рассинхрон не ломает экран, но и смысла в нём нет.
 */
object ChatCovers {
