...
@Serializable
data class EmailMsgForPasswordResetDbo(
...
class EmailMsgForPasswordResetRepository(
    collection: CoroutineCollection<EmailMsgForPasswordResetDbo>
) : BaseEmailMsgWithTokenRepository<EmailMsgForPasswordResetDbo>(collection) {

    // Implement the factory method
    override fun createEmailMsg(email: String, token: String): EmailMsgForPasswordResetDbo {
        return EmailMsgForPasswordResetDbo(
            email = email,
            token = token
        )
    }
