...
class UserRepository(
    ...
    companion object {
        const val DAILY_LIMIT_MESSAGES_REGULAR = 40
        const val HOURLY_LIMIT_MESSAGES_REGULAR = 15
        const val DAILY_LIMIT_MESSAGES_PREMIUM = 80
        const val HOURLY_LIMIT_MESSAGES_PREMIUM = 30
